...
| [IBD Distribution Day Monitor]({{ '/ja/skills/ibd-distribution-day-monitor/' | relative_url }}) ★ | QQQ/SPY のIBD式 Distribution Day を日次検出。リスク区分（NORMAL/CAUTION/HIGH/SEVERE）と TQQQ/QQQ エクスポージャ推奨を生成 | <span class="badge badge-api">FMP必須</span> |
