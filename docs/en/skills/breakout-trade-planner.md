...
**Required:**
- VCP screener JSON output with `schema_version: "1.0"` (generated by the [VCP Screener](../vcp-screener/) skill)
- Python 3.9+
...
Uses the [Position Sizer](../position-sizer/) skill internally:
