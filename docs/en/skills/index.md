...
|-------|-------------|-----|
| [Alpaca Executor]({{ '/en/skills/alpaca-executor/' | relative_url }}) | Execute equity trades on Alpaca (paper or live) as bracket orders with idempotency keys, mandatory stop-loss, and target | <span class="badge badge-free">No API</span> |
...
| [Eod Reconciliation]({{ '/en/skills/eod-reconciliation/' | relative_url }}) | End-of-day job that reconciles intraday loop decisions against actual Alpaca fills, updates trader-memory-core theses... | <span class="badge badge-free">No API</span> |
...
| [Kill Switch]({{ '/en/skills/kill-switch/' | relative_url }}) | Continuously watch Alpaca account state against the risk limits in trading_params | <span class="badge badge-free">No API</span> |
| [Macro Indicator Dashboard]({{ '/en/skills/macro-indicator-dashboard/' | relative_url }}) | Pull free macroeconomic data from the Federal Reserve Economic Data (FRED) API, score the current economic regime (Go... | <span class="badge badge-free">No API</span> |
...
| [Paper Replay Harness]({{ '/en/skills/paper-replay-harness/' | relative_url }}) | Deterministic historical replay of the trade loop | <span class="badge badge-free">No API</span> |
...
| [Relative Strength Momentum Scanner]({{ '/en/skills/relative-strength-momentum-scanner/' | relative_url }}) | IBD-style relative strength screener | <span class="badge badge-free">No API</span> |
...
| [Trade Loop Orchestrator]({{ '/en/skills/trade-loop-orchestrator/' | relative_url }}) | Main automated trading loop | <span class="badge badge-free">No API</span> |
