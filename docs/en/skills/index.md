...
| [Breakout Trade Planner]({{ '/en/skills/breakout-trade-planner/' | relative_url }}) | Generate Minervini-style breakout trade plan templates from VCP screener output with worst-case risk calculation, por... | <span class="badge badge-free">No API</span> |
