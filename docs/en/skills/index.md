...
| [Parabolic Short Trade Planner]({{ '/en/skills/parabolic-short-trade-planner/' | relative_url }}) | Screen US equities for parabolic exhaustion patterns and generate conditional pre-market short plans | <span class="badge badge-free">No API</span> |
